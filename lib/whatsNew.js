...
export const WHATS_NEW = [
  {
    ...
    date: '15 Junio 2026',
    title: 'Cargar ventas de otros días',
    pages: [
      {
        icon: '📅',
        title: 'Botón de fecha en el modal de pago',
        roles: ['*'],
        body: 'Si te olvidaste de cargar una venta ayer (o el internet estaba caído), ahora podés cargarla con la fecha real. En el modal de pago, arriba a la derecha hay un botón "Hoy". Click → date picker → elegí cualquier fecha hasta 7 días atrás.',
      },
      {
        icon: '⚠️',
        title: 'Reglas y guardrails',
        roles: ['*'],
        body: 'Para evitar errores grandes hay un tope: solo hasta 7 días atrás. Más allá no se puede.',
        items: [
          'La venta se guarda con la fecha que elegiste',
          'En la lista de Caja aparece en el día correcto, no hoy',
          'Se marca como "Venta retroactiva" en la nota para auditoría',
          'El recibo y la factura usan la fecha elegida',
        ],
        cta: 'Si necesitás cargar algo de hace más de 7 días, avisame al owner y lo cargamos manualmente.',
      },
      {
        icon: '🎯',
        title: 'Cómo se ve',
        roles: ['*'],
        body: 'Si dejás el botón en "Hoy", todo funciona igual que antes. Si elegís otra fecha, vas a ver un banner amber arriba que dice "Esta venta se registrará con fecha [...]" para que confirmes a la vista antes de cobrar.',
      },
    ],
  },
  {
